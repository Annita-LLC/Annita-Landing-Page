...
const partners: Partner[] = [
  ...
  { name: 'Afreximbank / MANSA', category: 'Due Diligence Repository', description: 'Officially onboarded onto MANSA, Africa\'s premier pan-African customer due diligence (CDD) and KYC repository platform launched by Afreximbank. Meeting MANSA\'s rigorous compliance standards reinforces Annita\'s commitment to transparency, credibility, and trust — the foundations of cross-border trade and investment in the AfCFTA era.', icon: Shield, tier: 'institutional', location: 'Cairo, Egypt', tags: ['KYC/CDD Compliance', 'Cross-Border Trade', 'AfCFTA', 'Institutional Trust'], metric: 'Verified', metricLabel: 'Due Diligence', logo: '/mansa-logo.png', logoType: 'local', website: 'https://www.mansaafrica.com/' },
...
const partnerQuotes = [
  ...
  { quote: 'Meeting MANSA\'s rigorous due diligence standards positions Annita as a trusted, transparent partner for cross-border trade in the AfCFTA era.', author: 'Afreximbank / MANSA', role: 'Pan-African CDD/KYC Repository', icon: Shield },
]
