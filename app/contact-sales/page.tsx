...
import { ArrowRight, Mail, Phone, Building2, Loader2, MessageSquare } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setModalLatency(healthCheck.latency)
        setFormData({ name: '', email: '', phone: '', companyName: '', projectDescription: '', budget: '', website_url: '' })
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] font-mono tracking-widest text-[var(--color-text-tertiary)] uppercase">
              SYS_NODE // <span className="text-[var(--color-accent)] font-bold">SALES_GATEWAY</span>
            </span>
          </motion.div>
          ...
          >
            <span className="text-[var(--color-text-primary)]">Enterprise</span><br />
            <span className="text-[var(--color-text-primary)]">Solutions.</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-sm text-[var(--color-text-secondary)]">sales@an-nita.com</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-[var(--color-text-primary)]" style={{ fontFamily: 'var(--font-syne)' }}>Enterprise</h3>
              <p className="text-sm text-[var(--color-text-secondary)]">Government & Large Organizations</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-[var(--color-text-secondary)] mb-4">Contact sales directly</p>
