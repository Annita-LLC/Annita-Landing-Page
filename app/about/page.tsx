    ...
    <div className="min-h-screen tech-grid" style={{ backgroundColor: '#080D1A', color: '#F0F4FF' }}>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-4 md:px-8 py-24 overflow-hidden tech-scanline">
        ...
        >
          ...
          >
            <span className="text-sm font-semibold tracking-[0.2em] uppercase" style={{ color: '#00C28A', fontFamily: 'var(--font-syne)' }}>ABOUT US</span>
          </motion.div>
      ...
      <footer className="py-8 px-4 md:px-8 max-w-[1400px] mx-auto" style={{ backgroundColor: '#080D1A', borderTop: '1px solid #1A2640' }}>
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
            ...
            <Link href="/about" className="text-sm hover:text-[#00C28A] transition-colors" style={{ color: '#8A9BBB' }}>About Us</Link>
