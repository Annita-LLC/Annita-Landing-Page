...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen tech-grid" style={{ backgroundColor: '#080D1A', color: '#F0F4FF' }}>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center px-4 md:px-8 py-24 overflow-hidden tech-scanline">
        ...
        >
          ...
          >
            <span className="text-sm font-semibold tracking-[0.2em] uppercase" style={{ color: '#00C28A', fontFamily: 'var(--font-syne)' }}>CONTACT US</span>
          </motion.div>
          ...
          >
            ...
            <span style={{ color: '#F0F4FF' }}>Together.</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-sm" style={{ color: '#8A9BBB' }}>info@an-nita.com</p>
            </motion.div>
            ...
            >
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: 'rgba(0, 194, 138, 0.1)' }}>
                <MapPin className="w-8 h-8" style={{ color: '#00C28A' }} />
              </div>
              <h3 className="text-xl font-bold mb-2" style={{ color: '#F0F4FF', fontFamily: 'var(--font-syne)' }}>Location</h3>
              <p className="text-sm" style={{ color: '#8A9BBB' }}>Monrovia, Liberia</p>
            </motion.div>
          </div>
        </div>
      </section>
